...
public class StringExample {
	...
	public static void main(String[] args) {
		...
		String str1=("Welcome to Full stock devolopement");
		String str2=("Welcome to Full stock devolopement");
		//by using new keyword
		String name=new String("Welcome to Full stock devolopement");
		String name1=new String("Welcome to Full stock devolopement");
		 ...
		 */
		System.out.println(155+5+5+"Hello"+30+60+90);
